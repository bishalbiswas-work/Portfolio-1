...
const Home: NextPage<IHomeProps> = ({ jobs, projects, skills }) => {
  ...
  return (
    <div>
      <Head>
        <title>Bishal Biswas</title>
        {/* <meta
          name="keywords"
          content="bishal_biswas, himanshu, kashyap, himanshu kashyap, iamhiman, lpu, dehradun, software developer, web developer"
        /> */}
        {/* <meta
          name="description"
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  // const { data } = await api.query({ query: QUERY });

  // const { skills, jobs, projects } = data;
  const { skills, jobs, projects } = { skills: null, jobs: null, projects: null };
